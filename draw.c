...
void drawTemplate(uint8_t * templateBuf, LpTiiTimeSeries *timeSeries, double dayStart, double dayEnd)
{
    ...
    // y2
    drawTimeSeries(templateBuf, timeSeries->lpTiiTime2Hz, timeSeries->y2H, timeSeries->n2Hz, plotX0, plotY0, plotWidth, plotHeight1, dayStart, dayEnd, 0, 20.0, "", "", 4, MAX_COLOR_VALUE+1, "0", "20", false, 1, 9);
    drawTimeSeries(templateBuf, timeSeries->lpTiiTime2Hz, timeSeries->y2V, timeSeries->n2Hz, plotX0, plotY0, plotWidth, plotHeight1, dayStart, dayEnd, 0, 20.0, "", "y2 (pix^2)", 4, 13, "0", "20", false, 1, 9);
    ...
    // VMCP
    drawTimeSeries(templateBuf, timeSeries->lpTiiTime2Hz, timeSeries->mcpVoltageSettingH, timeSeries->n2Hz, plotX0, plotY2, plotWidth, plotHeight1, dayStart, dayEnd, -2400, -1600.0, "", "", 4, MAX_COLOR_VALUE+1, "-2400", "-1600", false, 1, 9);
    drawTimeSeries(templateBuf, timeSeries->lpTiiTime2Hz, timeSeries->mcpVoltageSettingV, timeSeries->n2Hz, plotX0, plotY2, plotWidth, plotHeight1, dayStart, dayEnd, -2400, -1600.0, "", "VMCP (V)", 4, 13, "-2400", "-1600", false, 1, 9);
